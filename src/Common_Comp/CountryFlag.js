...
const CountryFlag = () => {
    const countries = [
        ...
        { src: singa, path: '/', alt: 'Singapore Visit Visa', name: 'Singapore Visit Visa' },
        { src: thi, path: '/', alt: 'Thailand Visit Visa', name: 'Thailand Visit Visa' },
        { src: mal, path: '/', alt: 'Malaysia Visit Visa', name: 'Malaysia Visit Visa' },
        { src: bal, path: '/', alt: 'Balu Visit Visa', name: 'Balu Visit Visa' },
        { src: tur, path: '/', alt: 'Turkey Visit Visa', name: 'Turkey Visit Visa' }
    ];
