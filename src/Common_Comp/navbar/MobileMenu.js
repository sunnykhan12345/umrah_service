                    ...
                    <ul className='flex flex-col gap-6 items-center'>
                        {
                            Links.map((link) => (
                                <li key={link.id}>
                                    <Link href={link.url} className={`capitalize text-base  font-bold font-Helvetica pb-6 text-black  ${pathname == link.url ? " border-white" : ""}`}>
                                        {link.name}
                                    </Link>
                                </li>
                            ))
...
{/* <li>
                            <Link href="/" className='text-sm font-medium text-black border-b pb-1.5 capitalize'>home</Link>
                        </li>
                        <li>
                            <Link href="/flights" className='text-sm font-medium text-black capitalize'>flights</Link>
                        </li>
                        <li>
                            <Link href="/umrrah" className='text-sm font-medium text-black capitalize'>tours</Link>
                        </li>
                        <li>
                            <Link href="/" className='text-sm font-medium text-black capitalize'>visa</Link>
                        </li>
                        <li>
                            <Link href="/" className='text-sm font-medium  text-black capitalize'>umrah packages</Link>
                        </li> */}
{/* <div className=''>
                            <button className='bg-blue-400 py-2 px-5 text-sm rounded-full text-white capitalize'>get started</button>
                        </div> */}
