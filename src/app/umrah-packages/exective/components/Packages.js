          ...
          {packCard.map((card) => (
            ...
            >
              ...
              <div className="lg:px-10 px-3 flex flex-col gap-y-3 mt-3">
                <h2 className="lg:my-2  lg:text-[22px] text-lg font-bold text-blue-400 hover:text-blue-600 cursor-pointer ">
                  {card.title}
                </h2>
                ...
                <div className="flex justify-between items-center pb-3">
                  <h5 className=" lg:text-lg text-base font-medium text-blue-400">
                    {" "}
                    ${card.price}
                  </h5>
