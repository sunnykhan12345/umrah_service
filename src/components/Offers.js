    ...
    return (
        <div className='lg:mt-20 mt-8 from-blue-200 to-white'>
            <div className="lg:container mx-auto px-5 from-blue-200 to-white">
                <h2 className='lg:text-[35px] text-2xl font-bold font-Helvetica text-black capitalize sm:py-6 sm:text-start text-center mb-2 border-l-8  border-blue-300 py-1 sm:pl-2 pl-1 '
