        ...
        <>
            <div className='lg:mt-20 mt-8 '>
                <div className="lg:container mx-auto px-5">
                    <h2 className='lg:text-[35px] text-2xl font-bold text-black  relative capitalize pb-8 sm:text-start  text-center '>Saveds Packages</h2>
                                ...
                                <div className='w-full'>
                                    <div className="bg-white py-3 px-5 rounded-2xl shadow-2xl relative">
                                        <div className="relative">
                                            <Image src={card.img} width={380} height={262} alt="" className="object-cover relative rounded-xl w-full" />
                                        ...
                                        <div className="flex justify-between pt-6 pl-2 ">
                                            ...
                                            <div className="flex items-center gap-[10px]">
                                                ...
                                                <h5 className="font-normal lg:text-[26px] text-[20px]">{card.ring}</h5>
                                            </div>
                                        </div>
                                        <p className="lg:text-[17px] text-base font-normal py-2">{card.para}</p>
                                        ...
                                        <div className="flex lg:gap-4 gap-1 items-center cursor-pointer">
                                            <del className="sm:text-base text-xs font-light">{card.old_price}</del>
                                            <h6 className="lg:text-[22px] text-base font-medium">{card.new_price} <sub className="sm:text-[13px] text-[11px] font-light">{card.sub}</sub></h6>
                                        </div>
                                    </div>
                                </div>
                            ))
