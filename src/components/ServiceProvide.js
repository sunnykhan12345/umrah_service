            ...
            >
              <div className="overflow-hidden rounded-2xl">
                <Image
                  src={card.img}
                  alt=""
                  className="w-full object-cover rounded-2xl shadow-2xl relative"
                />
              </div>
              <h5 className="absolute -mt-14 left-5  text-2xl font-medium font-Helvetica text-white cursor-pointer capitalize">
                {card.title}
              </h5>
