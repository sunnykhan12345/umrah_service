            ...
            <div className='lg:container mx-auto px-5'>
                ...
                <div className='overflow-x-scroll scrollbar-hide'>
                    <div className='flex gap-4 md:gap-6'>
                        <div className='bg-white duration-500 md:p-4 p-2 shadow-lg hover:shadow-xl cursor-pointer rounded-lg hover:scale-105 transition-all  flex-shrink-0 w-full sm:w-1/2 lg:w-1/3 xl:w-1/4'>
