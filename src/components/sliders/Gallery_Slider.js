...
const Gallery_Slider = () => {
    ...
    return (
        <Slider {...settings}>
            ...
            <div>
                <Image src={gallery3} width={344} height={428} alt="" className="w-[344px] h-[428px] object-cover" />
            </div>
            <div>
                <Image src={gallery4} width={344} height={428} alt="" className="w-[344px] h-[428px] object-cover" />
            </div>
            <div>
                <Image src={gallery1} width={344} height={428} alt="" className="w-[344px] h-[428px] object-cover" />
            </div>
