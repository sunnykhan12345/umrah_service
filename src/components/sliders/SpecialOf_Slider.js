        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
            ...
            >
                ...
                <div className="sm:text-start text-center">
                    <h5 className="md:text-[26px] text-[20px] font-medium font-Helvetica pb-4">15 Days Umrah Package</h5>
                    <p className="md:text-[17px] text-base font-medium pb-4 font-Helvetica text-[#2c3e50]">umrah e-visa | return air ticket | hotel | transport</p>
                    <h6 className="pb-7 md:text-[17px] text-base font-medium font-Helvetica"><b>PKR 195,000</b></h6>
