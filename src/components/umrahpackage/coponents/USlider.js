      ...
      <Slider {...settings}>
        <div className="relative w-full">
          <Image
            src={home}
            alt=""
            className="w-full bg-cover bg-center h-[clc(100vh-200px)]"
          />
          <div className="lg:container mx-auto px-5">
            <div className="absolute top-1/2  -translate-y-1/2  ">
              <h1 className="text-white font-bold lg:text-[79px] sm:text-[50px] text-[30px] text-lg lg:leading-[91px] sm:leading-[60px]">
